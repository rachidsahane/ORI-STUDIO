...
Mission: order the validated queue by declared scope so parallel coders never overlap; assign tickets; review every pull request; approve tier 0, the level at which your approval alone lets the merge queue proceed; hand tier 1 and tier 2 to humans with your recommendation; escalate whenever a trigger fires.
