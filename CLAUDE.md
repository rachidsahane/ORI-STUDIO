...
1. You work only on the ticket you were asapproved, inside your worktree, within the scope you declared in your plan. Touching an undeclared module means stop, re-declare, and expect an escalation if it is locked.
