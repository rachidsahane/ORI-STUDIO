...
**Delivers.** A-01, A-02, A-04, A-05, A-06, A-09; S-01; D-01, D-08, D-09, D-10, D-11, D-13, D-15; L-01; M-01, M-02, M-04, M-06, M-14; T-01 to T-07; F-02 (table), F-03 (tier 0 and 1), F-05, F-06; G-01 to G-03; V-03, V-04, V-06; Q-02 (label), Q-03; O-05; P-01 to P-05; K-01 to K-07, K-10; I-01, I-03, I-04, I-05; Z-01 to Z-04, Z-06; the crates ori-core, ori-store, ori-memory (without vectors), ori-broker (identities and keychain, injection), ori-runtime (worktrees, one ACP runtime, one headless adapter, budgets), ori-gates (coverage matrix, modified tests, citation, prover), ori-orchestrator (lifecycle, lock table, escalation, closing rules; merge queue for tier 0 and 1 with a single human), ori-watch, ori-mcp (server with the phase 1 tool subset, host), ori-integrations (traits, one vcs host reference adapter), ori-rpc (uds and named pipe), ori-engine, ori-cli.

**Phase set to sign before start.** PRD sections 3.1 to 3.6 for the listed features, API_SPEC, DATA_MODEL, LLD, `criteria/phase-1.md`, the QA agent's test plan for it.
...
**Delivers.** L-03, L-04, L-06; M-03; F-01, F-02 (partition), F-03 (full), F-08, F-09; G-04; V-02, V-05, V-07, V-08, V-11; Q-07; P-08, P-09; K-08, K-09; C-01, C-04; E-01, E-02; I-02 (CI), I-06; containers, the credential broker complete with the forbidden-action test on every permission change, lock table at scale, merge queue complete, calibration records, vectors in memory, the CI slot reference adapter.
...
**Delivers.** A-03, A-07, A-10, A-11, A-12; S-02, S-03, S-05; D-02 to D-07, D-14; L-02; M-05, M-07, M-08, M-09, M-12; T-08, T-09; F-04, F-07; G-06; V-01, V-09, V-10; P-06; C-07, C-08; N-01 to N-05; X-01 to X-03; I-02 (notification); R-01; Z-05; screens of PRD §6; the assistant role.
...
4. ori-broker: identities, keychain, injection at spawn, forbidden-action test harness.
5. ori-runtime: worktrees, ACP client, one headless adapter, budgets, transcripts, session recovery.
...
15. Fixtures: the three products; end-to-end suite; performance baselines; calibration of budgets on the first model.
